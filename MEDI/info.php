...
<body>
    ...
    <p class="title">Checkout</p>
        <div class="flex">
        <label>
            <input name="Firstname" required="" placeholder="" type="text" class="input">
            <span>Firstname</span>
        </label>

        <label>
            <input name="Lastname" required="" placeholder="" type="text" class="input">
            <span>Lastname</span>
        </label>
    </div>  
    ...
    <label>
        <input name="Contact" required="" placeholder="" type="text" class="input">
        <span>Active Contact No</span>
    </label>
    <label>
        <input name="Address" required="" placeholder="" type="address" class="input">
        <span>Address</span>
    </label>
    <button class="submit" value="submit" onClick="sumbit()"><a href="index.html">Submit</a></button>
